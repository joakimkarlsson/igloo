...
{
  struct ContextWithMetaData : public ContextProvider<ContextWithMetaData, ContextBase<void> >
  {
  ...
  {
    const std::string& string_metadata = context_with_metadata.GetMetaData("name of metadata");
  ...
  {
    const std::string& metadata = context_with_metadata.GetMetaData("non-existing metadata");
