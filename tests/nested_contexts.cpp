...
{   
  ...
  struct ContextToTest : public ContextProvider<ContextToTest, ContextWithAttribute<void>, false, false >
  {
    void SetUp()
    {
      log = "SetUp called ";
    ...
    struct InnerContext : public ContextProvider<InnerContext, ContextToTest, false, false>
    {
      void SetUp()
      {
